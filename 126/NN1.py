...
for i in sz:
    for e in earr:
        model.append(KerasRegressor(build_fn=create_model,epochs=e,batch_size=i,verbose=0))

run(models=model,yid=[0,1],track=2,blending=False,max_features=200,standardize=True,normalization=False,gen=True)
