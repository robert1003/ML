...
model.fit(train_x, train_y, eval_set=val, eval_metric='mae', early_stopping_rounds=6, xgb_model='../23/m1.model')
...
with open('train_stage_1_1.txt', 'w') as f:
    for i in prediction_train_1:
        print(i, file=f)
with open('test_stage_1_1.txt', 'w') as f:
